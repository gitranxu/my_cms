...
router.get('/floor_save_orders', function(req, res, next) {
	...
	var current_floor_id = _pool.escape(req.query.current_floor_id);
	var target_floor_id = _pool.escape(req.query.target_floor_id);
	var current_floor_order = _pool.escape(req.query.current_floor_order);
	var target_floor_order = _pool.escape(req.query.target_floor_order);
	var page_id = _pool.escape(req.query.pid);
...
router.post('/floor_delete', function(req, res, next) {
	...
	var page_id = _pool.escape(req.body.pid);
